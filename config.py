...
# A8 = 20.0
#紧时间窗
A1 = 150#100#150.0#120.0 #完成感知
A2 = 50#150.0# 150.0 #靠近任务点
A3 = 7.0#5.0#0.001#0.001#0.0001#0.001#0.0001 #能耗
A4 = 30.0#20.0#15.0# 碰撞
A5 = 15.0 #协同
A6 = 0.0#8.0#5.0  #R_attract
A7 = 10.0#10.0  # 3.0 #边界
A8 = 5.0#50.0#150.0#100#200.0#15.0 #R_Fairness
A9 = 0#10#30#50#80.0#30.0 方向驱动
