...
# A8 = 20.0
#紧时间窗
A1 = 50#150.0#120.0 #完成感知
A2 = 60.0#50.0#100.0#150.0#200.0  # 150.0 #靠近任务点
A3 = 0.0#0.001#0.0001#0.001#0.0001 #能耗
A4 = 15.0#0.3  # 1.0 # 碰撞
A5 = 15.0 #协同
A6 = 30.0#50.0#100#70.0#30.0 #R_attract
A7 = 10.0#10.0  # 3.0 #边界
A8 = 20.0#150.0#100#200.0#15.0 #时间窗
